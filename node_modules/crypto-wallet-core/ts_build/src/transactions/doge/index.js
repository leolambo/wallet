...
var DOGETxProvider = (function (_super) {
    ...
    function DOGETxProvider() {
        ...
        _this.lib = require('bitcore-lib-doge');
        return _this;
    }
    DOGETxProvider.prototype.create = function (_a) {
        var _this = this;
        var recipients = _a.recipients, _b = _a.utxos, utxos = _b === void 0 ? [] : _b, change = _a.change, wallet = _a.wallet, feeRate = _a.feeRate, _c = _a.fee, fee = _c === void 0 ? 20000 : _c;
